...
function Card(props) {
    ...
    return (
        <div style={{backgroundColor: '#fff', borderRadius: '5px', padding: '20px', marginRight: '20px', textAlign: 'left', height: '100%'}}>
            ...
            <div className="custom-scroll" style={{marginTop: '15px', overflowY:'auto',paddingBottom:'10px',height: '190px', fontSize:'15px'}}>{description}</div>
        </div>
    );
}
